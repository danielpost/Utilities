...
function createLine(children, line) {
	const properties = { className: 'line', dataLineNumber: line };
	...
	children = children.filter((child) => {
		...
		properties.dataHlFocus = value.includes('focus');
		properties.dataHlRemove = value.includes('--');
		properties.dataHlAdd = value.includes('++');
